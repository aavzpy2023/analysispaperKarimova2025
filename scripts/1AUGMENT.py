...
def select_features_by_permutation_importance(X, y, model, n_repeats=5):
    ...
    model.fit(X, y)
    print(f"  [PI] Computing Permutation Importance (n_repeats={n_repeats})...")
...
def run():
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # MODEL PERSISTENCE FOR VIRTUAL SCREENING (2FDA.py)
    # ──────────────────────────────────────────────────────────────────────────
    print("\n" + "─" * 100)
    ...
    print("[SAVE] Fitting clean baseline model (NO augmentation) on dev set for 2FDA.py...")
    ...
    print("\n[DONE] 1AUGMENT.py execution complete with Q1 statistical rigor.")
