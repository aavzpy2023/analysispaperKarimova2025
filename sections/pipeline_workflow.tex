		...
		\begin{tikzpicture}[
			...
			\node[phase2, right=of box1] (box2) {
				\begin{minipage}[t][\boxheight][t]{3.15cm}
					...
					\textbf{Prioritized Set:} \\$N = 17$ candidates
				\end{minipage}
			};
			...
			\node[phase4, right=of box3] (box4) {
				\begin{minipage}[t][\boxheight][t]{3.15cm}
					\centering
					\textbf{\footnotesize Phase 4: ADMET Filter} \par\vspace{2pt}\hrule\vspace{7pt}
					\textbf{Input:} \\Docking consensus set \par\vspace{4pt}
					\textbf{Druggability:} \\Lipinski Rule of 5 \par\vspace{4pt}
					\textbf{Absorption:} \\Caco-2 ($> -5.15$) \par\vspace{4pt}
					\textbf{Safety:} \\hERG ($P_\mathrm{block} < 0.5$) \par\vspace{4pt}
